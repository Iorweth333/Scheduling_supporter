...
import ioiobagiety.exception.FileStorageException;
import ioiobagiety.exception.MyFileNotFoundException;
...
public class BasicFileStorageService implements FileStorageService {
    ...
    @Autowired
    public BasicFileStorageService(FileStorageProperties fileStorageProperties) {
